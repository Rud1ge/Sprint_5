...
class TestCreateAdAuthorizedUser:
    def test_create_ad_authorized_user(self, driver, existing_user_credentials):
        ...
        WebDriverWait(driver, 3).until(expected_conditions.visibility_of_element_located((By.XPATH, FIELD_AD_NAME)))
        ...
        category_option = WebDriverWait(driver, 3).until(
        ...
        city_option = WebDriverWait(driver, 3).until(
